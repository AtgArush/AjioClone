      ...
      <View style={{flex: 1}}>
        ...
        <View style={{height: 580}}>
          ...
          <View style={{alignItems: 'center', marginTop: 30}}>
            <View
              style={styles.orSection}>
              <View
                style={styles.horizontalLines}></View>
...
const styles = StyleSheet.create({
  ...
  bodyHead:{
    color: "#fe4a56", fontSize: 35, marginTop: 40, marginLeft: 15, fontFamily: "AkayaTelivigala-Regular"
  },
  buttonBox:{
  ...
  horizontalLines:{
    flex: 0.44, height: 2, backgroundColor: '#555'
  },
  orSection:{
    display: 'flex',
    flexDirection: 'row',
