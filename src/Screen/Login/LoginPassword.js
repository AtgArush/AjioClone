    ...
    return (
      <View style = {{flex: 1}}>
        <View style = {styles.topBar}>
          ...
          <Text style = {[styles.headerText, {marginBottom: 70}]}>Welcome back!!</Text>
          </View>

        </View>
        <View style = {{height: 580}}>
        <TextInput onChangeText = {(value)=> this.getInputValue(value)} style = {styles.inputField} 
        placeholder = "Password"
        />
        <View style = {styles.forgotPasswordButton}>
          <Text style = {{color: "#4052e4", fontSize: 18}}>Forgot Password?</Text>
        </View>
